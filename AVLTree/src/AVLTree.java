...
public class AVLTree extends Node{
	...
	private void _insert(Node node, int value, Queue<Node> nodeQueue) {
		if (value < node.getValue()) {
			...
			System.out.println("O valor j� existe na �rvore");
	}
	...
	*/
	...
	private Node leftRotation(Node node) {
		System.out.println("\n\nRota��o a esquerda porque FB � negativo e seu filho a direita tamb�m tem FB negativo");
	...
	private Node rightRotation(Node node) {
		System.out.println("\n\nRota��o a direita porque FB � positivo e seu filho a esquerda tamb�m tem FB positivo");
	...
	private Node doubleLeftRotation(Node node) {
		System.out.println("\n\nRota��o a dupla a esquerda porque FB � negativo e seu filho a direita tamb�m tem FB positivo");
		node.setRight(rightRotation(node.getRight()));
		return leftRotation(node);
	}
	
	private Node doubleRightRotation(Node node) {
		System.out.println("\n\nRota��o a dupla a esquerda porque FB � positivo e seu filho a esquerda tamb�m tem FB negativo");
	...
	public void remove(int value) {
		...
		if(search(node, value) == null) {
			System.out.println("O valor digitado n�o est� na �rvore!");
			return;
		}
